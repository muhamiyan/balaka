...
public class InventoryValuationReportPage {

    private final Page page;
    private final String baseUrl;

    public InventoryValuationReportPage(Page page, String baseUrl) {
        this.page = page;
    ...
    public void assertPageTitleVisible() {
        page.locator("h1:has-text('Laporan Penilaian Persediaan')").waitFor();
    }
