...
public class ProductProfitabilityReportPage {

    private final Page page;
    private final String baseUrl;

    public ProductProfitabilityReportPage(Page page, String baseUrl) {
        this.page = page;
    ...
    public void assertPageTitleVisible() {
        page.locator("h1:has-text('Laporan Profitabilitas Produk')").waitFor();
    }
    ...
    public String getTotalRevenueText() {
        return page.locator(".text-blue-600:has-text('Rp')").textContent().replace("Rp ", "").trim();
    }

    public String getTotalMarginText() {
